...
Because B<Module::Install> itself only supports 5.004, it will silently
add the equivalent of a C<configure_requires( perl => '5.004' );>
...
You should also strongly avoid the use of auto_install.
