...
B<Do not use pass-through Build.PL files.>

B<They turned out to be highly buggy and dangerous and no longer
recommended in any situations.>

B<Support will be dropped in a future release.>
